 ...
 * Passive buzzer connected to buzzPin
...
long frequency;
long minFrequency = 99; //minimum frequency in Hz to be generated (0 means silence)
long maxFrequency = 16600; //maximum frequency in Hz to be generated
